        ...
        <div class="maincontainer">
            ...
            <div class="planItemCell" v-for="item in planNameData" :key="item.toString()">
                ...
                <div>
                    ...
                    <el-button :class="{'btnSelect':selectNameArr.indexOf(item1) >  -1}" type="text" class="btn" v-for="item1 in item.PlanList" :key="item1.toString()" @click="addBtn(item1)">{{item1}}</el-button> 
                </div>
            </div>
